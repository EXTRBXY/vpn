...
internal sealed class MainAppContext : ApplicationContext
{
    ...
    public MainAppContext(StartupArgs? startup, SingleInstance singleInstance)
    {
        ...
        var appUpdateController = new AppUpdateController(services.AppUpdateService, services.SettingsService);
        ...
        _mainForm = new MainForm(
            ...
            appUpdateController,
            services.InstallerUpdateService,
            services.InstallerLaunchService,
